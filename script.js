...
const DEFAULT_STATE = {
  ...
  'cta-link':      'https://wa.me/553199256152?text=Ol%C3%A1%21%20Quero%20fazer%20um%20site%20profissional%20para%20minha%20empresa.',
  'logo-text':     'AtlasWeb',
  'footer-text':   '© 2025 AtlasWeb. Todos os direitos reservados.',
  'whatsapp-link': 'https://wa.me/553199256152?text=Ol%C3%A1%21%20Quero%20fazer%20um%20site%20profissional%20para%20minha%20empresa.',
...
async function loadStateFromCloud() {
  ...
  try {
    ...
    // Se a nuvem tiver links com número placeholder, usa o DEFAULT
    ['whatsapp-link', 'cta-link'].forEach(k => {
      if (!merged[k] || merged[k].includes('0000000000')) merged[k] = DEFAULT_STATE[k];
    });
    return merged;
  } catch (err) {
